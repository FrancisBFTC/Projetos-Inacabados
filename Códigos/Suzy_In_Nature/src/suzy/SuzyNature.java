...
public class SuzyNature extends JFrame{
	...
	public SuzyNature(){
		...
		//ícones menus
		ImageIcon simbolRoupa = new ImageIcon(getClass().getResource("/simbols/roupa.jpg"));
		//menina
		ImageIcon menina1 = new ImageIcon(getClass().getResource("/girl/menina1.jpg"));
		ImageIcon menina2 = new ImageIcon(getClass().getResource("/girl/menina2.jpg"));
		ImageIcon menina3 = new ImageIcon(getClass().getResource("/girl/menina3.jpg"));
		ImageIcon menina4 = new ImageIcon(getClass().getResource("/girl/menina4.jpg"));
		
		//menina conversando
		ImageIcon meninaConv1 = new ImageIcon(getClass().getResource("/talking/meninaConvBranco1.jpg"));
		ImageIcon meninaConv2 = new ImageIcon(getClass().getResource("/talking/meninaConvBranco2.jpg"));
		ImageIcon meninaConv3 = new ImageIcon(getClass().getResource("/talking/meninaConvBranco3.jpg"));
		ImageIcon meninaConv4 = new ImageIcon(getClass().getResource("/talking/meninaConvBranco4.jpg"));
		
		//menina piscando
		ImageIcon piscBranco1 = new ImageIcon(getClass().getResource("/pisk/pisc1.jpg"));
		ImageIcon piscBranco2 = new ImageIcon(getClass().getResource("/pisk/pisc2.jpg"));
		ImageIcon piscBranco3 = new ImageIcon(getClass().getResource("/pisk/pisc3.jpg"));
		ImageIcon piscBranco4 = new ImageIcon(getClass().getResource("/pisk/pisc4.jpg"));
		ImageIcon piscAzul1 = new ImageIcon(getClass().getResource("/pisk/piscAzul1.jpg"));
		ImageIcon piscAzul2 = new ImageIcon(getClass().getResource("/pisk/piscAzul2.jpg"));
		ImageIcon piscAzul3 = new ImageIcon(getClass().getResource("/pisk/piscAzul3.jpg"));
		ImageIcon piscAzul4 = new ImageIcon(getClass().getResource("/pisk/piscAzul4.jpg"));
		ImageIcon piscVerde1 = new ImageIcon(getClass().getResource("/pisk/piscVerde1.jpg"));
		ImageIcon piscVerde2 = new ImageIcon(getClass().getResource("/pisk/piscVerde2.jpg"));
		ImageIcon piscVerde3 = new ImageIcon(getClass().getResource("/pisk/piscVerde3.jpg"));
		ImageIcon piscVerde4 = new ImageIcon(getClass().getResource("/pisk/piscVerde4.jpg"));
		ImageIcon piscVermelho1 = new ImageIcon(getClass().getResource("/pisk/piscVermelho1.jpg"));
		ImageIcon piscVermelho2 = new ImageIcon(getClass().getResource("/pisk/piscVermelho2.jpg"));
		ImageIcon piscVermelho3 = new ImageIcon(getClass().getResource("/pisk/piscVermelho3.jpg"));
		ImageIcon piscVermelho4 = new ImageIcon(getClass().getResource("/pisk/piscVermelho4.jpg"));
